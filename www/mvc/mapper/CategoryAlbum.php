...
class CategoryAlbum extends Mapper implements \MVC\Domain\CategoryAlbumFinder {

    function __construct() {
        parent::__construct();
				
		$tblCategory = "www_category_album";
    ...
    function getCollection( array $raw ) {
        return new CategoryAlbumCollection( $raw, $this );
    }

    protected function doCreateObject( array $array ) {
        $obj = new \MVC\Domain\CategoryAlbum( 
			$array['id'],
			$array['name'],
			$array['order'],
			$array['key']
	...
	function findByPage( $values ) {		
        ...
        return new CategoryAlbumCollection( $this->findByPageStmt->fetchAll(), $this );
    }
}
?>