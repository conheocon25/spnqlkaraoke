...
class Course extends Object{
	...
	function getURLRecipeInsLoad(){return "/setting/category/".$this->getIdCategory()."/".$this->getId()."/recipe/ins/load";}
	function getURLRecipeInsExe(){return "/setting/category/".$this->getIdCategory()."/".$this->getId()."/recipe/ins/exe";}
