...
--
-- Client: localhost
-- Généré le: Dim 29 Septembre 2013 à 23:02
...
--
-- Base de données: `spngroup_kara_demo1`
--
...
(1, 'Karaoke Ba Đức', '0945 03 07 09', 'Phó Cơ Điều P3 - TPVL', '', 'data/images/banner/logo.png', 'demo1_', 'demo1_', '2012-06-30 22:00:00', '0000-00-00 00:00:00', '2012-12-26 13:28:02', 0, 0);
...
--
-- Contenu de la table `demo1_collect_customer`
--
...
(3, '113.161.196.216', '1380513240', '1380516840', '113.161.196.216');
...
CREATE TABLE IF NOT EXISTS `demo1_paid_pay_roll` (
  ...
  `note` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `demo1_paid_pay_roll_1` (`idemployee`)
...
(1, 'Demo 1', 'demo1111@gmail.com', 'admin123456', 0, ' ', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 4, '');
