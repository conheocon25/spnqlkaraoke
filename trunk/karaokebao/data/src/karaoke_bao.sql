...
--
-- Base de données: `spngroup_kara_karaokebao`
--

-- --------------------------------------------------------

--
-- Structure de la table `karaokebao_app`
--

CREATE TABLE IF NOT EXISTS `karaokebao_app` (
...
--
-- Contenu de la table `karaokebao_app`
--

INSERT INTO `karaokebao_app` (`id`, `name`, `phone`, `address`, `email`, `banner`, `prefix`, `alias`, `date_created`, `date_modified`, `date_activity`, `type`, `page_view`) VALUES
(1, 'Karaoke Ba Đức', '0945 03 07 09', 'Phó Cơ Điều P3 - TPVL', '', 'data/images/banner/logo.png', 'karaokebao_', 'karaokebao_', '2012-06-30 22:00:00', '0000-00-00 00:00:00', '2012-12-26 13:28:02', 0, 0);

-- --------------------------------------------------------

--
-- Structure de la table `karaokebao_category`
--

CREATE TABLE IF NOT EXISTS `karaokebao_category` (
...
--
-- Contenu de la table `karaokebao_category`
--

INSERT INTO `karaokebao_category` (`id`, `name`, `picture`) VALUES
(3, 'BEER', NULL),
...
--
-- Structure de la table `karaokebao_collect_customer`
--

CREATE TABLE IF NOT EXISTS `karaokebao_collect_customer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `karaokebao_customer_collect_1` (`idcustomer`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=4 ;

--
-- Contenu de la table `karaokebao_collect_customer`
--

INSERT INTO `karaokebao_collect_customer` (`id`, `idcustomer`, `date`, `value`, `note`) VALUES
...
--
-- Structure de la table `karaokebao_collect_general`
--

CREATE TABLE IF NOT EXISTS `karaokebao_collect_general` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `note` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `karaokebao_collect_1` (`id_term`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=7 ;

--
-- Contenu de la table `karaokebao_collect_general`
--

INSERT INTO `karaokebao_collect_general` (`id`, `id_term`, `date`, `value`, `note`) VALUES
...
--
-- Structure de la table `karaokebao_config`
--

CREATE TABLE IF NOT EXISTS `karaokebao_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Contenu de la table `karaokebao_config`
--

INSERT INTO `karaokebao_config` (`id`, `param`, `value`) VALUES
...
--
-- Structure de la table `karaokebao_course`
--

CREATE TABLE IF NOT EXISTS `karaokebao_course` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Contenu de la table `karaokebao_course`
--

INSERT INTO `karaokebao_course` (`id`, `idcategory`, `name`, `shortname`, `unit`, `price1`, `price2`, `price3`, `price4`, `picture`) VALUES
...
--
-- Structure de la table `karaokebao_customer`
--

CREATE TABLE IF NOT EXISTS `karaokebao_customer` (
...
--
-- Contenu de la table `karaokebao_customer`
--

INSERT INTO `karaokebao_customer` (`id`, `name`, `type`, `card`, `phone`, `address`, `note`, `discount`) VALUES
...
--
-- Structure de la table `karaokebao_domain`
--

CREATE TABLE IF NOT EXISTS `karaokebao_domain` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=4 ;
...
--
-- Contenu de la table `karaokebao_domain`
--

INSERT INTO `karaokebao_domain` (`id`, `name`) VALUES
(1, 'KHU A'),
(2, 'KHU B'),
(3, 'KHU VIP');
...
--
-- Structure de la table `karaokebao_employee`
--

CREATE TABLE IF NOT EXISTS `karaokebao_employee` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Contenu de la table `karaokebao_employee`
--

INSERT INTO `karaokebao_employee` (`id`, `name`, `job`, `gender`, `phone`, `address`) VALUES
...
--
-- Structure de la table `karaokebao_guest`
--

CREATE TABLE IF NOT EXISTS `karaokebao_guest` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Contenu de la table `karaokebao_guest`
--

INSERT INTO `karaokebao_guest` (`id`, `ip`, `entry_time`, `exit_time`, `agent`) VALUES
(2, '192.168.1.3', '1379611115', '1379614715', '192.168.1.3');

-- --------------------------------------------------------

--
-- Structure de la table `karaokebao_order_import`
--

CREATE TABLE IF NOT EXISTS `karaokebao_order_import` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idsupplier` int(11) NOT NULL,
  `date` date NOT NULL,
  `description` varchar(50) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`id`),
  KEY `karaokebao_order_import_1` (`idsupplier`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=124 ;

--
-- Contenu de la table `karaokebao_order_import`
--

INSERT INTO `karaokebao_order_import` (`id`, `idsupplier`, `date`, `description`) VALUES
(7, 9, '2013-04-07', ''),
(10, 12, '2013-04-01', ''),
(11, 12, '2013-04-02', ''),
(12, 12, '2013-04-04', ''),
...
--
-- Structure de la table `karaokebao_order_import_detail`
--

CREATE TABLE IF NOT EXISTS `karaokebao_order_import_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `karaokebao_order_import_detail_1` (`idorder`),
  KEY `karaokebao_order_import_detail_2` (`idresource`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=209 ;

--
-- Contenu de la table `karaokebao_order_import_detail`
--

INSERT INTO `karaokebao_order_import_detail` (`id`, `idorder`, `idresource`, `count`, `price`) VALUES
(2, 7, 44, 100, 3000),
(3, 10, 53, 2, 10000),
(4, 11, 54, 2, 15000),
(5, 11, 53, 1, 15000),
...
--
-- Structure de la table `karaokebao_paid_customer`
--

CREATE TABLE IF NOT EXISTS `karaokebao_paid_customer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idcustomer` int(11) NOT NULL,
  `date` date NOT NULL,
  `value` int(11) NOT NULL,
  `note` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `karaokebao_customer_paid_1` (`idcustomer`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=19 ;

--
-- Contenu de la table `karaokebao_paid_customer`
--

INSERT INTO `karaokebao_paid_customer` (`id`, `idcustomer`, `date`, `value`, `note`) VALUES
(18, 1, '2013-05-16', 1, '');

-- --------------------------------------------------------

--
-- Structure de la table `karaokebao_paid_general`
--

CREATE TABLE IF NOT EXISTS `karaokebao_paid_general` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_term` int(11) NOT NULL,
  `date` date NOT NULL,
  `value` int(11) NOT NULL,
  `note` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `karaokebao_paid_1` (`id_term`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=89 ;

--
-- Contenu de la table `karaokebao_paid_general`
--

INSERT INTO `karaokebao_paid_general` (`id`, `id_term`, `date`, `value`, `note`) VALUES
...
--
-- Structure de la table `karaokebao_paid_pay_roll`
--

CREATE TABLE IF NOT EXISTS `karaokebao_paid_pay_roll` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `note` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `karaokebao_paid_pay_roll_1` (`idemployee`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=5 ;

--
-- Contenu de la table `karaokebao_paid_pay_roll`
--

INSERT INTO `karaokebao_paid_pay_roll` (`id`, `idemployee`, `date`, `value_base`, `value_sub`, `value_pre`, `note`) VALUES
...
--
-- Structure de la table `karaokebao_paid_supplier`
--

CREATE TABLE IF NOT EXISTS `karaokebao_paid_supplier` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idsupplier` int(11) NOT NULL,
  `date` date NOT NULL,
  `value` int(11) NOT NULL,
  `note` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `karaokebao_supplier_paid_1` (`idsupplier`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=18 ;

--
-- Contenu de la table `karaokebao_paid_supplier`
--

INSERT INTO `karaokebao_paid_supplier` (`id`, `idsupplier`, `date`, `value`, `note`) VALUES
...
--
-- Structure de la table `karaokebao_r2c`
--

CREATE TABLE IF NOT EXISTS `karaokebao_r2c` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `karaokebao_r2c_1` (`id_course`),
  KEY `karaokebao_r2c_2` (`id_resource`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=52 ;

--
-- Contenu de la table `karaokebao_r2c`
--

INSERT INTO `karaokebao_r2c` (`id`, `id_course`, `id_resource`, `value1`, `value2`) VALUES
(28, 114, 24, 24, 1),
(29, 108, 20, 24, 1),
(30, 113, 23, 24, 1),
(31, 114, 1, 10, 1),
...
--
-- Structure de la table `karaokebao_resource`
--

CREATE TABLE IF NOT EXISTS `karaokebao_resource` (
  `id` int(9) NOT NULL AUTO_INCREMENT,
  `idsupplier` int(11) NOT NULL,
  `name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `karaokebao_resource_1` (`idsupplier`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=77 ;

--
-- Contenu de la table `karaokebao_resource`
--

INSERT INTO `karaokebao_resource` (`id`, `idsupplier`, `name`, `unit`, `price`, `description`) VALUES
...
--
-- Structure de la table `karaokebao_session`
--

CREATE TABLE IF NOT EXISTS `karaokebao_session` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `idtable` (`idtable`),
  KEY `iduser` (`iduser`),
  KEY `karaokebao_session_3` (`idcustomer`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=441 ;

--
-- Contenu de la table `karaokebao_session`
--

INSERT INTO `karaokebao_session` (`id`, `idtable`, `iduser`, `idcustomer`, `datetime`, `datetimeend`, `note`, `status`, `discount_value`, `discount_percent`, `surtax`, `payment`, `value`) VALUES
...
--
-- Structure de la table `karaokebao_session_detail`
--

CREATE TABLE IF NOT EXISTS `karaokebao_session_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Contenu de la table `karaokebao_session_detail`
--

INSERT INTO `karaokebao_session_detail` (`id`, `idsession`, `idcourse`, `count`, `price`) VALUES
...
--
-- Structure de la table `karaokebao_store`
--

CREATE TABLE IF NOT EXISTS `karaokebao_store` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Contenu de la table `karaokebao_store`
--

INSERT INTO `karaokebao_store` (`id`, `name`, `note`) VALUES
(1, 'Kho nhà', 'Ghi chú gì đây ?');

-- --------------------------------------------------------

--
-- Structure de la table `karaokebao_supplier`
--

CREATE TABLE IF NOT EXISTS `karaokebao_supplier` (
  `id` int(9) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `phone` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `address` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Contenu de la table `karaokebao_supplier`
--

INSERT INTO `karaokebao_supplier` (`id`, `name`, `phone`, `address`, `note`, `debt`) VALUES
...
--
-- Structure de la table `karaokebao_table`
--

CREATE TABLE IF NOT EXISTS `karaokebao_table` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Contenu de la table `karaokebao_table`
--

INSERT INTO `karaokebao_table` (`id`, `iddomain`, `name`, `iduser`, `type`) VALUES
(1, 1, 'Phòng 01', 0, '0'),
(2, 1, 'Phòng 02', 0, '0'),
(3, 1, 'Phòng 03', 0, '0'),
(4, 1, 'Phòng 04', 0, '0'),
...
--
-- Structure de la table `karaokebao_term`
--

CREATE TABLE IF NOT EXISTS `karaokebao_term` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `type` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Contenu de la table `karaokebao_term`
--

INSERT INTO `karaokebao_term` (`id`, `name`, `type`) VALUES
(1, 'Tiền Điện', 0),
(2, 'Tiền Nước', 0),
(3, 'Thuế', 0),
(4, 'Lương Nhân Viên', 0),
...
--
-- Structure de la table `karaokebao_term_collect`
--

CREATE TABLE IF NOT EXISTS `karaokebao_term_collect` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=4 ;
...
--
-- Contenu de la table `karaokebao_term_collect`
--

INSERT INTO `karaokebao_term_collect` (`id`, `name`) VALUES
(2, 'Phụ Phẩm'),
(3, 'Đặc Biệt');
...
--
-- Structure de la table `karaokebao_tracking`
--

CREATE TABLE IF NOT EXISTS `karaokebao_tracking` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Contenu de la table `karaokebao_tracking`
--

INSERT INTO `karaokebao_tracking` (`id`, `date_start`, `date_end`, `estate_rate`) VALUES
...
--
-- Structure de la table `karaokebao_tracking_store`
--

CREATE TABLE IF NOT EXISTS `karaokebao_tracking_store` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Structure de la table `karaokebao_unit`
--

CREATE TABLE IF NOT EXISTS `karaokebao_unit` (
  `id` int(25) NOT NULL AUTO_INCREMENT,
  `name` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=18 ;
...
--
-- Contenu de la table `karaokebao_unit`
--

INSERT INTO `karaokebao_unit` (`id`, `name`) VALUES
(1, 'Ly'),
(2, 'Điếu'),
(3, 'Chai'),
(4, 'Lon'),
...
--
-- Structure de la table `karaokebao_user`
--

CREATE TABLE IF NOT EXISTS `karaokebao_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(25) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Contenu de la table `karaokebao_user`
--

INSERT INTO `karaokebao_user` (`id`, `name`, `email`, `pass`, `gender`, `note`, `datecreate`, `dateupdate`, `dateactivity`, `type`, `code`) VALUES
(1, 'karaokebao', 'karaokebao111@gmail.com', 'admin123456', 0, ' ', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 4, '');
...
--
-- Contraintes pour la table `karaokebao_collect_customer`
--
ALTER TABLE `karaokebao_collect_customer`
  ADD CONSTRAINT `karaokebao_customer_collect_1` FOREIGN KEY (`idcustomer`) REFERENCES `karaokebao_customer` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `karaokebao_collect_general`
--
ALTER TABLE `karaokebao_collect_general`
  ADD CONSTRAINT `karaokebao_collect_general_1` FOREIGN KEY (`id_term`) REFERENCES `karaokebao_term_collect` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `karaokebao_course`
--
ALTER TABLE `karaokebao_course`
  ADD CONSTRAINT `karaokebao_course_1` FOREIGN KEY (`idcategory`) REFERENCES `karaokebao_category` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `karaokebao_order_import`
--
ALTER TABLE `karaokebao_order_import`
  ADD CONSTRAINT `karaokebao_order_import_1` FOREIGN KEY (`idsupplier`) REFERENCES `karaokebao_supplier` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `karaokebao_order_import_detail`
--
ALTER TABLE `karaokebao_order_import_detail`
  ADD CONSTRAINT `karaokebao_order_import_detail_1` FOREIGN KEY (`idorder`) REFERENCES `karaokebao_order_import` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `karaokebao_order_import_detail_2` FOREIGN KEY (`idresource`) REFERENCES `karaokebao_resource` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `karaokebao_paid_customer`
--
ALTER TABLE `karaokebao_paid_customer`
  ADD CONSTRAINT `karaokebao_customer_paid_1` FOREIGN KEY (`idcustomer`) REFERENCES `karaokebao_customer` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `karaokebao_paid_general`
--
ALTER TABLE `karaokebao_paid_general`
  ADD CONSTRAINT `karaokebao_paid_general_1` FOREIGN KEY (`id_term`) REFERENCES `karaokebao_term` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `karaokebao_paid_supplier`
--
ALTER TABLE `karaokebao_paid_supplier`
  ADD CONSTRAINT `karaokebao_supplier_paid_1` FOREIGN KEY (`idsupplier`) REFERENCES `karaokebao_supplier` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `karaokebao_r2c`
--
ALTER TABLE `karaokebao_r2c`
  ADD CONSTRAINT `karaokebao_r2c_1` FOREIGN KEY (`id_course`) REFERENCES `karaokebao_course` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `karaokebao_r2c_2` FOREIGN KEY (`id_resource`) REFERENCES `karaokebao_resource` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `karaokebao_resource`
--
ALTER TABLE `karaokebao_resource`
  ADD CONSTRAINT `karaokebao_resource_1` FOREIGN KEY (`idsupplier`) REFERENCES `karaokebao_supplier` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `karaokebao_session`
--
ALTER TABLE `karaokebao_session`
  ADD CONSTRAINT `karaokebao_session_1` FOREIGN KEY (`idtable`) REFERENCES `karaokebao_table` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `karaokebao_session_2` FOREIGN KEY (`iduser`) REFERENCES `karaokebao_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `karaokebao_session_3` FOREIGN KEY (`idcustomer`) REFERENCES `karaokebao_customer` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `karaokebao_session_detail`
--
ALTER TABLE `karaokebao_session_detail`
  ADD CONSTRAINT `karaokebao_session_detail_1` FOREIGN KEY (`idsession`) REFERENCES `karaokebao_session` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `karaokebao_session_detail_2` FOREIGN KEY (`idcourse`) REFERENCES `karaokebao_course` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `karaokebao_table`
--
ALTER TABLE `karaokebao_table`
  ADD CONSTRAINT `karaokebao_table_1` FOREIGN KEY (`iddomain`) REFERENCES `karaokebao_domain` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
