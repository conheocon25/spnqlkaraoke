...
class OrderImportDetail extends Mapper implements \MVC\Domain\OrderImportDetailFinder {
    ...
    function __construct() {
		...
		$tblOrderImport = "demo2_order_import";
		$tblOrderImportDetail = "demo2_order_import_detail";
		...
		$trackByExportStmt = sprintf("
			...
			from
				demo2_session S inner join demo2_session_detail SD on S.id = SD.idsession
			where
				SD.idcourse IN(select id_course from demo2_r2c where id_resource=?) AND
